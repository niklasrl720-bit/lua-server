...
function getNexuRoleInfo(userId) {const id = cleanNumericId(userId);if (id === MENU_CREATOR_USER_ID) {return {title: "MENU CREATOR", key: "creator"};}if (SUPPORTER_USER_IDS.has(id)) {return {title: "SUPPORTER", key: "supporter"};}return {title: "SPIELER", key: "player"};}
